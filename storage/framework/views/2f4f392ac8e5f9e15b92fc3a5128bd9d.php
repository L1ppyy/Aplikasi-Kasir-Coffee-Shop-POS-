...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — POSMaster</title>
...
<body>
    <aside class="sidebar">
        <div class="sidebar-logo">
            ...
            <div>
                <div class="sidebar-logo-text">Kopi Halaman</div>
        ...
        <nav class="sidebar-nav">
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('cashier.index')); ?>" class="nav-link">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.transactions.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.transactions*') ? 'active' : ''); ?>">
                    <span class="nav-icon">🧾</span> Transaksi
                </a>
                <a href="<?php echo e(route('admin.expenses.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.expenses*') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-title">
                ...
                <p><?php echo $__env->yieldContent('page-subtitle', ''); ?></p>
            </div>
...
<?php /**PATH D:\Alifiann\Project Full Stack\pos-laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>