...
<title>Kasir — <?php echo e($settings['store_name']); ?></title>
...
<div class="pos-topbar">
  <div class="pos-topbar-left">
    <span class="pos-logo">🏪 <?php echo e($settings['store_name']); ?></span>
    <span class="pos-time" id="posTime"></span>
  </div>
  <div class="pos-topbar-right">
    <span class="cashier-name">👤 <?php echo e(auth()->user()->name); ?></span>
    <?php if(auth()->user()->isAdmin()): ?>
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="topbar-btn topbar-btn-ghost">📊 Admin</a>
    <?php endif; ?>
    <a href="<?php echo e(route('cashier.history')); ?>" class="topbar-btn topbar-btn-ghost">📋 Riwayat</a>
...
<div class="pos-body">
  ...
  <div class="products-panel">
    ...
    <div class="cat-bar">
      ...
      <button class="cat-btn" data-cat="<?php echo e($cat->id); ?>" style="--cat-color:<?php echo e($cat->color); ?>">
    ...
    <div class="product-grid-wrap">
      <div class="product-grid" id="productGrid">
        ...
        <div class="product-card <?php echo e($product->stock <= 0 ? 'out-of-stock' : ''); ?>"
             ...
             data-cat="<?php echo e($product->category_id); ?>"
             onclick="addToCart(this)">
          <div class="product-img-placeholder">
            <?php if($product->image): ?>
            <img src="<?php echo e(asset('storage/'.$product->image)); ?>" style="width:100%;height:100%;object-fit:cover;border-radius:8px;">
            <?php else: ?>
          ...
          <div class="product-price">Rp <?php echo e(number_format($product->selling_price, 0, ',', '.')); ?></div>
          <div class="product-stock <?php echo e($product->stock <= $product->min_stock ? 'low' : ''); ?>">
            Stok: <?php echo e($product->stock); ?> <?php echo e($product->unit); ?>
  ...
  <div class="cart-panel">
    ...
    <div class="cart-footer">
      ...
      <div class="summary-row" id="taxDisplay" style="<?php echo e($settings['tax_percent']>0?'':'display:none'); ?>">
        <span class="label">Pajak (<?php echo e($settings['tax_percent']); ?>%)</span>
...
<script>
const TAX_PERCENT = <?php echo e($settings['tax_percent'] ?? 0); ?>;
let cart = [];
...
const amountPaid =
  ...
  try {
    const res = await fetch('<?php echo e(route("cashier.checkout")); ?>', {
      method: 'POST',
...
function newTransaction() {
  ...
  fetch('<?php echo e(route("cashier.products")); ?>').then(r=>r.json()).then(products=>{
    products.forEach(p => {
...
<?php /**PATH D:\Alifiann\Project Full Stack\pos-laravel\resources\views/cashier/index.blade.php ENDPATH**/ ?>