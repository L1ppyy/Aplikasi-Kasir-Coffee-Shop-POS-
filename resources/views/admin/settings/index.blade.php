...
@section('page-subtitle','Konfigurasi toko dan aplikasi POS')
    ...
    <div class="card-body">
      <div class="form-grid">
        ...
        <div class="form-group full">
          ...
          <img src="{{ asset('storage/'.$settings['logo']) }}" style="width:80px;height:80px;object-fit:cover;border-radius:10px;border:1px solid #e2e8f0;margin-bottom:8px;display:block;">
          @endif
    ...
    <div class="card-body">
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="number" name="tax_percent" class="form-control" value="{{ $settings['tax_percent'] ?? '0' }}" min="0" max="100" step="0.5">
        ...
        <div class="form-group">
          ...
          <select name="currency" class="form-control">
            ...
            <option value="MYR" {{ ($settings['currency']??'IDR')=='MYR'?'selected':'' }}>MYR - Ringgit</option>
          </select>
        </div>
        <div class="form-group full">
          <label class="form-label">Pesan Footer Struk</label>
          <input type="text" name="receipt_footer" class="form-control" value="{{ $settings['receipt_footer'] ?? '' }}" placeholder="Contoh: Terima kasih atas kunjungan anda!">
        </div>
      </div>
    </div>
  </div>
