        ...
        <form action="{{ route('login.submit') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="admin@pos.com" required autofocus>
                </div>
            </div>
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <span class="input-icon">✉️</span>
                        <input type="email" name="email" class="form-control" placeholder="alifian@gmail.com" value="{{ old('email') }}" required autofocus>
                    </div>
                </div>
